...
# data = pd.read_excel(r'C:\Users\Matt\Dropbox\1 Job Search Related Items\Daily '
# 'Work Log.xlsx', sheet_name='TWC Work Search Log')
...
driver = webdriver.Firefox(
    executable_path=r'D:\Users\Matt\Documents\GitHub\Automatic-Unemployment\ge'
    'ckodriver.exe'
)
